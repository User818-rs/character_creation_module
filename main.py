...
def defence(char_name: str, char_class: str) -> str:
    """Данная функция блокирует получение урона."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Данная функция применяет специальноые умения."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Данная функция производит обучение персонажа."""
    if char_class == 'warrior':
    ...
    return 'Тренировка окончена.'[str]


def choice_char_class() -> str:
    """Данная функция описывает разновидности классов и их умения."""
